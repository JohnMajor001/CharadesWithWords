// NAME: VERBALISE?!!!!
/* Things to do
                Doesn't currently let you move forward from teams - 
                Rules - add better content
...
var internets = {
    ...
    array: ['Memes', 'White-guilt', 'Black Lives Matter', 'All Lives Matter', 'Hashtag', 'Twitter', 'Facebook', 'Bebo', 'MySpace',
            ...
            'Piratebay', 'Trial Account', 'Random', 'Actual footage of', 'Archbishop of Banterbury', 'Esteemed Character Actress Margo Martindale'],
};
...
var person = {
  ...
  array: ['Charlie Chaplain', 'Hugh Jackman', 'Second Cousin', 'Rachel Bloom', 'Vasyl Lomachenko', 'Gervonta Davis', 'Sylvestor Stalone', 'Jennifer Aniston', 
          ...
          'Daniel Radcliffe', 'Simon Pegg', 'Christopher Eccleston', 'Ralph Fiennes'],
