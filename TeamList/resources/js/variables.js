...
var tempDrinkingRules = ['Describer, if anything you described is in the room with you now, drink twice.', 'Drink if you would rather not drink',
                  ...
                  whoever loses DIES. Just kidding, loser drinks.`, 'For the room: drink if you`ve ever done anal and enjoyed it.',
                  ...
                  'For the room: drink if you didn\'t want to play this game.', '*crooning* Happy birthday to you, Happy birthday to you, Happy birthday dear ROOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO, happy birthday to you! P.s. Drink if it\'s your birthday party (GET FUCKED BROTHAAAA)',
                  'Whoever has the longest first name, drink three times', 'Drink if you believe in God. If you don\'t believe, your punishment is burning in hell.',
                  ...
                  'Drink if one of your feet is slightly longer than the other.', 'Drink if you have ever found yourself disgusting the moment after you orgasm from masterbating to pornography.',
                  'Everyone reveals the weirdest dream that they remember having. Group votes who\'s is the least weird. They drink.', 'Drink if you believe in ghosts. OoooooOOOooooh. P.s. it was your dad in a sheet, get over it.', `Everyone reveals the age that they stopped 
                  ...
                  'Drink if you would pick Eraser man (FS Mark).', 'Drink if you have masterbated today', 'Drink if you were a c-section birth or whatever the fuck it\'s called',
                  ...
                  'Drink if either one of your parents could be described as at least fairly racist.', 'Drink if you have ever called a teacher "mum.', 'Drink if you have ever played wonderwall at a house party',
                  'Drink if you have blue eyes, Aryan scum', 'Drink if you are a noob. p.s. you\'re all noobs', 'Drink if you are or have ever considered becoming a vegan', 'Drink if you think the russians are planning on poisoning Theresa May\'s Alpen',
